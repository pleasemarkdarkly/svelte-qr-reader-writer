...
>
    <div class="container py-6">
        ...
        <div class="flex justify-center mt-6">
            <div
                class="bg-white border rounded-md focus-within:ring focus-within:border-blue-500"
            >
                <div class="flex flex-wrap justify-between md:flex-row">
                    ...
                    />
                    <button
                        class="w-full p-2 m-1 text-sm font-semibold text-white uppercase transition-colors duration-200 transform bg-gray-800 rounded lg:w-auto hover:bg-gray-700"
                        >subscribe</button
                    >
                </div>
            </div>
