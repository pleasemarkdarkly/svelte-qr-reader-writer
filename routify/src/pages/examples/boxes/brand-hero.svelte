    ...
    <nav class="px-6 py-3 shadow">
        <div class="items-center justify-between md:flex">
            ...
            <div class="flex flex-col mt-2 -mx-2 md:mt-0 md:flex-row md:block">
                <a
                    href="/"
                    class="px-2 py-2 text-sm text-gray-800 rounded dark:text-gray-200 hover:bg-gray-900 hover:text-gray-100 hover:font-medium md:mx-2"
                    >Home</a
                >
                <a
                    href="/"
    ...
    <div class="md:flex">
        ...
        >
            <div class="max-w-xl">
                ...
                >
                    Build Your New <span
                        class="text-indigo-600 dark:text-indigo-400">Idea</span
                    >
                </h2>

                <p
                    class="mt-2 text-sm text-gray-500 dark:text-gray-400 md:text-base"
                >
                ...
                <div class="flex mt-6">
                    <a
                        href="/"
                        class="block px-3 py-2 text-xs font-semibold text-white transition-colors duration-200 transform bg-gray-900 rounded hover:bg-gray-700"
                        >Get Started</a
                    >
                    <a
                        href="/"
                        class="block px-3 py-2 mx-4 text-xs font-semibold text-gray-700 transition-colors duration-200 transform bg-gray-200 rounded hover:bg-gray-300"
                        >Learn More</a
                    >
                </div>
            </div>
